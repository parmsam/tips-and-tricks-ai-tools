...
Follow [Tom Mock](https://github.com/jthomasmock)'s framework called S^2^C that he [presented at Posit Conf 2023](https://colorado.posit.co/rsc/rstudio-copilot/#/11) for Github Copilot prompting: Simple, Specific, and use Comments. This framework can be applied to any AI tool. 
...
Here are some of the key points from the talk:
  ...
  - Prompt again or in a different way (a mentioned in the *iterate on it* section) if you don't get the results you want.
